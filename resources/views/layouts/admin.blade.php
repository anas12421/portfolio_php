...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend_assets') }}/vendor/chartist/css/chartist.min.css">
    <link href="{{ asset('backend_assets') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css"
        rel="stylesheet">

    <link href="{{ asset('backend_assets') }}/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route('dash') }}" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('backend_assets') }}/images/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('backend_assets') }}/images/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('backend_assets') }}/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{ asset('backend_assets') }}/email-inbox.html"
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('user.list') }}">User's List</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('logo') }}">Logo List</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('menu') }}">Menu List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('meter') }}">Meter List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('banner') }}">Banner List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('feature') }}">Features's List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('service') }}">Service's List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('work') }}">Work's List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('skill') }}">Skill's List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('contact.card') }}">Contact Card</a></li>
                            <li><a href="{{ route('contact.list') }}">Contact's List</a></li>
                        </ul>
                    </li>
                    ...
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ asset('backend_assets') }}/uc-select2.html">Select 2</a></li>
                            <li><a href="{{ asset('backend_assets') }}/uc-nestable.html">Nestedable</a></li>
                            <li><a href="{{ asset('backend_assets') }}/uc-noui-slider.html">Noui Slider</a></li>
                            <li><a href="{{ asset('backend_assets') }}/uc-sweetalert.html">Sweet Alert</a></li>
                            <li><a href="{{ asset('backend_assets') }}/uc-toastr.html">Toastr</a></li>
                            <li><a href="{{ asset('backend_assets') }}/map-jqvmap.html">Jqv Map</a></li>
                            <li><a href="{{ asset('backend_assets') }}/uc-lightgallery.html">Lightgallery</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ asset('backend_assets') }}/form-element.html">Form Elements</a></li>
                            <li><a href="{{ asset('backend_assets') }}/form-wizard.html">Wizard</a></li>
                            <li><a href="{{ asset('backend_assets') }}/form-editor-summernote.html">Summernote</a>
                            </li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ asset('backend_assets') }}/page-register.html">Register</a></li>
                            <li><a href="{{ asset('backend_assets') }}/page-login.html">Login</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                                <ul aria-expanded="false">
                                    <li><a href="{{ asset('backend_assets') }}/page-error-400.html">Error 400</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/page-error-403.html">Error 403</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/page-error-404.html">Error 404</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/page-error-500.html">Error 500</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/page-error-503.html">Error 503</a></li>
                                </ul>
                            </li>
                            <li><a href="{{ asset('backend_assets') }}/page-lock-screen.html">Lock Screen</a></li>
                        </ul>
                    </li> --}}
                </ul>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('backend_assets') }}/vendor/global/global.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    <script src="{{ asset('backend_assets') }}/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
    <script src="{{ asset('backend_assets') }}/vendor/chart.js/Chart.bundle.min.js"></script>
    <script src="{{ asset('backend_assets') }}/js/custom.min.js"></script>
    <script src="{{ asset('backend_assets') }}/js/deznav-init.js"></script>
    <script src="{{ asset('backend_assets') }}/vendor/owl-carousel/owl.carousel.js"></script>
    ...
    <script src="{{ asset('backend_assets') }}/vendor/peity/jquery.peity.min.js"></script>

    <!-- Apex Chart -->
    <script src="{{ asset('backend_assets') }}/vendor/apexchart/apexchart.js"></script>

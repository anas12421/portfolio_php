                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('feature.update', $feature->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="" class="form-control" cols="30" rows="4">{{ $feature->description }}</textarea>
                        </div>

                        <div class="mb-3"><button class="btn btn-primary">Update Feature</button></div>
                    </form>
                </div>
            </div>
        </div>
